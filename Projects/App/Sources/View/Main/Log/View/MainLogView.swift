...
//  WithYou
//
//  Created by 김도경 on 3/28/24.
//  Copyright © 2024 withyou.org. All rights reserved.
//

import UIKit

class MainLogView : BaseUIView{
    ...
    public func moveEclipse(_ state: Bool){
        self.eclipse.snp.updateConstraints{
            $0.centerX.equalTo(state ? ing.snp.centerX : upcoming.snp.centerX)
        }
    }
}
